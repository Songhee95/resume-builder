$(document).ready(function () {
  $.get("/api/user_resume", function (data) {
    ...
    data.forEach(function (resume) {
      let resumeTile =
        "<div class='tile is-3 has-text-centered'><div class='tile is-parent'><article class='tile is-child notification is-warning'><a class='resumeName' href ='/templateOne/";
      resumeTile += resume.id;
      resumeTile += "'>";
      resumeTile += resume.resumeName;
      resumeTile +=
        "<figure class='image is-3by3'><img src='https://png.pngtree.com/png-clipart/20200709/original/pngtree-elegant-minimalistic-modern-vector-resume-or-cv-template-designed-on-a4-png-image_3528067.jpg'></figure></a>";
      resumeTile += "<div><button class='resumeEditButton' data-id='";
      resumeTile += resume.id;
      resumeTile +=
        "'>edit</button><button class='resumeDeleteButton' data-id='";
      resumeTile += resume.id;
